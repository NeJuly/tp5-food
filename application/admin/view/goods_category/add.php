        ...
        <form role="form" method="post" action="" id="cateAddForm">
            <div class="box-body">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="name" placeholder="请输入商品分类名称" name="name">
                </div>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control select2 select2-hidden-accessible" style="width: 100%;" tabindex="-1" aria-hidden="true" name="parent_id">
                        ...
                        <option value="{$cate.id}">{$cate.depth}{$cate.name}</option>
                        {/volist}
                    </select>
                </div>
                <div class="form-group">
                    <label>Intro</label>
                    <textarea class="form-control" rows="3" name="intro" placeholder="请输入商品分类的简介 ..."></textarea>
                </div>
            </div>
            <!-- /.box-body -->
